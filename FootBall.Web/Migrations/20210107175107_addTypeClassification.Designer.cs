...
namespace FootBall.Web.Migrations
{
    ...
    [Migration("20210107175107_addTypeClassification")]
    partial class addTypeClassification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FootBall.Web.Data.Entities.SessionEntity", b =>
                {
                    ...
                    b.Property<int?>("TypeSessionId");

                    b.HasKey("Id");

                    b.HasIndex("TournamentId");

                    b.HasIndex("TypeSessionId");
            ...
            modelBuilder.Entity("FootBall.Web.Data.Entities.TypeSessionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FootBall.Web.Data.Entities.SessionEntity", b =>
                {
                    ...
                    b.HasOne("FootBall.Web.Data.Entities.TypeSessionEntity", "TypeSession")
                        .WithMany("Sessions")
                        .HasForeignKey("TypeSessionId");
                });
